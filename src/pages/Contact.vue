        ...
        <form name="sentMessage" id="contactForm" novalidate>
          <div class="control-group">
            <div class="form-group floating-label-form-group controls">
              <label>Name</label>
              <input v-model="name" type="text" class="form-control" placeholder="Name" id="name" required data-validation-required-message="Please enter your name.">
          ...
          <div class="control-group">
            <div class="form-group col-xs-12 floating-label-form-group controls">
              ...
              <input v-model="phone" type="tel" class="form-control" placeholder="Phone Number" id="phone" required data-validation-required-message="Please enter your phone number.">
              <p class="help-block text-danger"></p>
            </div>
          </div>
          <div class="control-group">
...
export default {
    ...
    methods:{
      onSubmit(){
        axios.post('https://xyfcms.applinzi.com/contacts',{
          name:this.name,
          email:this.email,
          message:this.message,
          phone:this.phone
        }).then((data)=>{
          confirm('提交成功，作者会收到你的反馈!')
          this.$router.push("/")
        }).catch(err=>{
          alert('提交失败，请在控制台查看错误信息!')
